...
# Read in Oculina GO, Symbiont comparisons
Ocu_Heat_Sym_BP = read.table("../GO_DEGs/Oculina/GO_MWU_outputs/MWU_BP_heat_sym_results_modified_pvalues.csv", header = T)
Ocu_Heat_Sym_MF = read.table("../GO_DEGs/Oculina/GO_MWU_outputs/MWU_MF_heat_sym_results_modified_pvalues.csv", header = T)
Ocu_Heat_Sym_CC = read.table("../GO_DEGs/Oculina/GO_MWU_outputs/MWU_CC_heat_sym_results_modified_pvalues.csv", header = T)
...
#### Control Treatment ####
# Read in Oculina GO, Symbiont comparisons
Ocu_control_Sym_BP = read.table("../GO_DEGs/Oculina/GO_MWU_outputs/MWU_BP_sym_control_results_modified_pvalues.csv", header = T)
Ocu_control_Sym_MF = read.table("../GO_DEGs/Oculina/GO_MWU_outputs/MWU_MF_sym_control_results_modified_pvalues.csv", header = T)
Ocu_control_Sym_CC = read.table("../GO_DEGs/Oculina/GO_MWU_outputs/MWU_CC_sym_control_results_modified_pvalues.csv", header = T)

# Biological Processes
control_sym_goods = intersect(Ocu_control_Sym_BP$term, Dixon_BP$term)
control_sym = Ocu_control_Sym_BP[Ocu_control_Sym_BP$term %in% control_sym_goods,]
...
# Molecular Function
control_sym_goods_MF = intersect(Ocu_control_Sym_MF$term, Dixon_MF$term)
control_sym_MF = Ocu_control_Sym_MF[Ocu_control_Sym_MF$term %in% control_sym_goods_MF,]
...
# Cellular Component
control_sym_goods_CC = intersect(Ocu_control_Sym_CC$term, Dixon_CC$term)
control_sym_CC = Ocu_control_Sym_CC[Ocu_control_Sym_CC$term %in% control_sym_goods_CC,]
...
#### Cold Treatment ####
# Read in Oculina GO, Symbiont comparisons
Ocu_Cold_Sym_BP = read.table("../GO_DEGs/Oculina/GO_MWU_outputs/MWU_BP_cold_sym_results_modified_pvalues.csv", header = T)
Ocu_Cold_Sym_MF = read.table("../GO_DEGs/Oculina/GO_MWU_outputs/MWU_MF_cold_sym_results_modified_pvalues.csv", header = T)
Ocu_Cold_Sym_CC = read.table("../GO_DEGs/Oculina/GO_MWU_outputs/MWU_CC_cold_sym_results_modified_pvalues.csv", header = T)

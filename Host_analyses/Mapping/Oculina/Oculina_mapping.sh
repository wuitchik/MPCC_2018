## November 2021, mapping to Oculina to Astrangia genome and B. psygmophilum transcriptome 
# working directory
/projectnb/coral/MPCC_2018/oculina_nov_2021/

# local directory
/Users/danielwuitchik/Documents/Experiments/MPCC_2018/Combined
...
# these files look like Oculina_OA4_S45_R1_001.fastq.gz, so we need to strip the characters into something meaningful, here I strip the first 15 characters
for i in *.fastq
    do mv "$i" "`echo $i | sed 's/Oculina_O//'`"
done
...
../tagseq_files/expression_compiler.pl *.counts.txt > oculina_holobiont_counts.txt

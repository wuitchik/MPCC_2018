...
countDataHost_clones_removed = countDataHost %>%
  select(-c(OP1_C_W, OP2_F_W, OP3_H_W, OO1_C_W, OO2_F_W, OM1_C_B, OM2_F_B, OM3_H_B, OK1_C_W, OK2_F_W, OK3_H_W, OA4_C_W, OA5_F_W, OA6_H_W))
...
#how many FDR < 10%?
table(res_hot_brown_host$padj<0.1) # we actually get more DEGs when genotype is included in model.
# 0.1=328
# 0.05=214
# 0.01=108
...
#how many FDR < 10%?
table(res_cold_brown_host$padj<0.1)
# 0.1=4091
# 0.05=3280
# 0.01=2106
...
host_degs = data.frame(
  ...
  number = c(134, -194, 31, -64, 1839, -2252, 1096, -1258)
)
...
annotate_text = data.frame(
  ...
  temperature_direction = factor(c("heat_up","heat_down", "heat_up","heat_down", "cold_up","cold_down","cold_up","cold_down")),
  x = c(1,1,1,1,2,2,2,2),
  y = c(1950,-2350,1200,-1400,250,-300,150,-200)
)
...
adonis2(pca$x ~ treatment + sym_state, data = pcadata, method = 'eu')
...
# (Intercept)             20.569      1.934  10.635 3.73e-11 ***
# treat_typecold_sym       6.699      2.425   2.763 0.010186 *  
# treat_typecontrol_apo   -7.714      2.735  -2.820 0.008883 ** 
# treat_typecontrol_sym  -14.200      2.425  -5.857 3.09e-06 ***
# treat_typeheat_apo     -11.367      2.735  -4.156 0.000293 ***
# treat_typeheat_sym     -13.828      2.425  -5.704 4.64e-06 ***

aov = aov(dist ~ treat_type, data = all_plast)
summary(aov)
#             Df Sum Sq Mean Sq F value   Pr(>F)    
# treat_type   5   2276   455.3   30.43 2.73e-10 ***
# Residuals   27    404    15.0                     

TukeyHSD(aov)
# $treat_type
#                                diff         lwr         upr     p adj
# cold_sym-cold_apo         6.6988164  -0.7295874  14.1272202 0.0951206
# control_apo-cold_apo     -7.7142377 -16.0946075   0.6661320 0.0844709
# control_sym-cold_apo    -14.1995227 -21.6279265  -6.7711189 0.0000421
# heat_apo-cold_apo       -11.3665248 -19.7468945  -2.9861550 0.0035859
# heat_sym-cold_apo       -13.8284324 -21.2568363  -6.4000286 0.0000628
# control_apo-cold_sym    -14.4130541 -21.8414579  -6.9846503 0.0000334
# control_sym-cold_sym    -20.8983391 -27.2333031 -14.5633750 0.0000000
# heat_apo-cold_sym       -18.0653411 -25.4937450 -10.6369373 0.0000007
# heat_sym-cold_sym       -20.5272488 -26.8622129 -14.1922848 0.0000000
# control_sym-control_apo  -6.4852850 -13.9136888   0.9431189 0.1136883
# heat_apo-control_apo     -3.6522870 -12.0326568   4.7280827 0.7632909
# heat_sym-control_apo     -6.1141947 -13.5425985   1.3142091 0.1531168
# heat_apo-control_sym      2.8329979  -4.5954059  10.2614018 0.8476250
# heat_sym-control_sym      0.3710903  -5.9638738   6.7060543 0.9999709
# heat_sym-heat_apo        -2.4619077  -9.8903115   4.9664961 0.9087069
...
ggsave(plast_boxplot, filename = "/Users/hannahaichelman/Documents/BU/Host_Buffering/MPCC_2018/Sym_analyses/plots/PCA_plasticity_boxplot_host.pdf", width=3, height=3, units=c("in"), useDingbats=FALSE)

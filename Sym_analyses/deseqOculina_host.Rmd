...
brown.adonis.output = adonis(pca.brown$x ~ genotype + treatment, data = pcadata.brown, method = 'eu')
brown.adonis.output
...
white.adonis.output = adonis(pca.white$x ~ genotype + treatment, data = pcadata.white, method = 'eu')
white.adonis.output
# Terms added sequentially (first to last)
# 
#           Df SumsOfSqs MeanSqs F.Model      R2 Pr(>F)    

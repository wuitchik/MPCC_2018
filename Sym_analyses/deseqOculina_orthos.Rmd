...
write.csv(norm.counts.ortho, "/Users/hannahaichelman/Documents/BU/Host_Buffering/MPCC_2018/Sym_analyses/tables/Oculina_normalized_counts_ortho_batch_corr.csv") #these are all counts, not considering treatment comparisons
...
#FALSE  TRUE 
#163    9 
table(resWhiteHostH.WhiteHostC$padj<0.05)
#0.1=4
#0.05=0
#0.01=0
...
#FALSE  TRUE 
#126    46
table(resWhiteHostF.WhiteHostC$padj<0.05)
#0.1=41
#0.05=26
#0.01=18
...
#FALSE  TRUE 
#155   17
table(resSymInHostH.SymInHostC$padj<0.01)
#0.1=2
#0.05=0
#0.01=0
...
#FALSE  TRUE 
#166   6
table(resSymInHostF.SymInHostC$padj<0.01)
#0.1=3
#0.05=1
#0.01=0
...
```
Cold versus control expression comparison - Symbiont In Culture
...
```{r, cache=TRUE, fig.align='center'}
norm_counts = read.csv("/Users/hannahaichelman/Documents/BU/Host_Buffering/MPCC_2018/Sym_analyses/tables/Oculina_normalized_counts_ortho_batch_corr.csv")
...
ortho_combined_degs = data.frame(
  ...
  type = factor(c("Sym_Host", "Sym_Host", "Sym_Host","Sym_Host",
                  ...
                  "Sym_InCulture", "Sym_InCulture", "Sym_InCulture", "Sym_InCulture")),
  direction = factor(c("up","down","up","down",
                       "up","down","up","down",
                       "up","down","up","down",
                       "up","down","up","down")),
  type_temperature_direction = factor(c("sym_host_heat_up","sym_host_heat_down", "sym_host_cold_up","sym_host_cold_down",
                                   "apo_host_heat_up","apo_host_heat_down", "apo_host_cold_up","apo_host_cold_down",
                                   "sym_inhost_heat_up","sym_inhost_heat_down", "sym_inhost_cold_up","sym_inhost_cold_down",
                                   "culture_heat_up","culture_heat_down", "culture_cold_up","culture_cold_down")),
  number = c(2, -12, 28, -27, 
             3, -1, 24, -17,
             0, -2, 1, -2,
             11, -10, 15, -5)
...
annotate_text = data.frame(
  ...
  x = c(1,1,1,1,2,2,2,2),
  y = c(80,-75,5,-5,80,-80,25,-40)
)


deg_cols = c("sym_host_cold_up" = "#3182bd", "sym_host_cold_down" =  "#9ecae1","sym_host_heat_up" = "#de2d26", "sym_host_heat_down" ="#fc9272", "apo_host_cold_up" = "#3182bd", "apo_host_cold_down" =  "#9ecae1","apo_host_heat_up" = "#de2d26", "apo_host_heat_down" ="#fc9272","culture_cold_up" = "#74c476", "culture_cold_down" =  "#c7e9c0","culture_heat_up" = "#fd8d3c", "culture_heat_down" ="#fdd0a2","sym_inhost_cold_up" = "#74c476", "sym_inhost_cold_down" =  "#c7e9c0","sym_inhost_heat_up" = "#fd8d3c", "sym_inhost_heat_down" ="#fdd0a2")
...
ggsave(deg_barplot, file = "/Users/hannahaichelman/Documents/BU/Host_Buffering/MPCC_2018/Sym_analyses/plots/orthos_deg_barplot.pdf", width=6, height=4, units=c("in"), useDingbats=FALSE)
```
...
And finally sym in culture orthologs
```{r cache=TRUE}

...
keep.corr = rowSums(counts(dds.corr) >= 5) >= 33 # at least 33 samples (80%) with a count of 5 or higher
...
sym_combined_degs = data.frame(
  ...
  number = c(115, -150, 22, -60, 154, -139, 2, 2)
)
...
# treat_type  5   484.82 0.34691 3.7183  0.001 ***
# Residual   35   912.73 0.65309                  
# Total      40  1397.55 1.00000                  
...
# (Intercept)                5.93505    0.47139  12.590 1.48e-14 ***
# treat_typecold_inhost     -4.19932    0.59092  -7.106 2.79e-08 ***
# treat_typecontrol_culture -4.12519    0.57733  -7.145 2.48e-08 ***
# treat_typecontrol_inhost  -5.21854    0.59092  -8.831 1.97e-10 ***
# treat_typeheat_culture    -0.09608    0.57733  -0.166 0.868779    
# treat_typeheat_inhost     -2.57692    0.59092  -4.361 0.000109 ***

aov = aov(dist ~ treat_type, data = all_plast)
check_model(aov) # visually check assumptions
summary(aov)
#             Df Sum Sq Mean Sq F value   Pr(>F)    
# treat_type   5 158.69   31.74   35.71 8.54e-13 ***
# Residuals   35  31.11    0.89                     

TukeyHSD(aov)
#                                       diff         lwr        upr     p adj
# cold_inhost-cold_culture       -4.19932321 -5.97992529 -2.4187211 0.0000004
# control_culture-cold_culture   -4.12518973 -5.86485295 -2.3855265 0.0000004
# control_inhost-cold_culture    -5.21854136 -6.99914344 -3.4379393 0.0000000
# heat_culture-cold_culture      -0.09608386 -1.83574708  1.6435794 0.9999805
# heat_inhost-cold_culture       -2.57692299 -4.35752506 -0.7963209 0.0014121
# control_culture-cold_inhost     0.07413348 -1.39615030  1.5444173 0.9999876
# control_inhost-cold_inhost     -1.01921815 -2.53772070  0.4992844 0.3506328
# heat_culture-cold_inhost        4.10323935  2.63295557  5.5735231 0.0000000
# heat_inhost-cold_inhost         1.62240022  0.10389767  3.1409028 0.0304938
# control_inhost-control_culture -1.09335163 -2.56363541  0.3769321 0.2455979
# heat_culture-control_culture    4.02910587  2.60867679  5.4495349 0.0000000
# heat_inhost-control_culture     1.54826674  0.07798297  3.0185505 0.0341507
# heat_culture-control_inhost     5.12245750  3.65217372  6.5927413 0.0000000
# heat_inhost-control_inhost      2.64161837  1.12311582  4.1601209 0.0001061
# heat_inhost-heat_culture       -2.48083913 -3.95112290 -1.0105554 0.0001698

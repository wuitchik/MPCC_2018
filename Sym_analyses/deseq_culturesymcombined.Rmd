...
#how many FDR < 10%?
table(res_hot_culture_corr$padj<0.05)
# 0.1=138
# 0.05=122
# 0.01=85
...
#how many FDR < 10%?
table(res_hot_inhost_corr$padj<0.05)
# 0.1=53
# 0.05=39
# 0.01=25
...
#how many FDR < 10%?
table(res_cold_culture_corr$padj<0.05)
# 0.1=138
# 0.05=111
# 0.01=78
...
#how many FDR < 10%?
table(res_cold_inhost_corr$padj<0.05)
# 0.1=1
# 0.05=1
# 0.01=1
...
sym_combined_degs = data.frame(
  ...
  number = c(64, -74, 18, -35, 70, -68, 1, 0)
)
...
# (Intercept)                3.92633    0.32685  12.012 1.65e-14 ***
# treat_typecold_inhost     -2.88986    0.40031  -7.219 1.25e-08 ***
# treat_typecontrol_culture -2.52672    0.40031  -6.312 2.13e-07 ***
# treat_typecontrol_inhost  -3.34095    0.40031  -8.346 4.03e-10 ***
# treat_typeheat_culture    -0.08823    0.40031  -0.220 0.826741    
# treat_typeheat_inhost     -1.64548    0.40031  -4.110 0.000203 ***

aov = aov(dist ~ treat_type, data = all_plast)
summary(aov)
#             Df Sum Sq Mean Sq F value  Pr(>F)    
# treat_type   5  68.81  13.761    32.2 1.1e-12 ***
# Residuals   38  16.24   0.427                    

TukeyHSD(aov)
# $treat_type
#                                       diff         lwr        upr     p adj
# cold_inhost-cold_culture       -2.88985740 -4.09078090 -1.6889339 0.0000002
# control_culture-cold_culture   -2.52672359 -3.72764709 -1.3258001 0.0000031
# control_inhost-cold_culture    -3.34094803 -4.54187154 -2.1400245 0.0000000
# heat_culture-cold_culture      -0.08822862 -1.28915213  1.1126949 0.9999223
# heat_inhost-cold_culture       -1.64547971 -2.84640322 -0.4445562 0.0026051
# control_culture-cold_inhost     0.36313381 -0.61741613  1.3436837 0.8737968
# control_inhost-cold_inhost     -0.45109064 -1.43164058  0.5294593 0.7383410
# heat_culture-cold_inhost        2.80162878  1.82107884  3.7821787 0.0000000
# heat_inhost-cold_inhost         1.24437768  0.26382775  2.2249276 0.0061565
# control_inhost-control_culture -0.81422445 -1.79477439  0.1663255 0.1523457
# heat_culture-control_culture    2.43849497  1.45794503  3.4190449 0.0000001
# heat_inhost-control_culture     0.88124387 -0.09930606  1.8617938 0.0995753
# heat_culture-control_inhost     3.25271941  2.27216948  4.2332694 0.0000000
# heat_inhost-control_inhost      1.69546832  0.71491838  2.6760183 0.0001023
# heat_inhost-heat_culture       -1.55725109 -2.53780103 -0.5767012 0.0003742
...
ggsave(plast_boxplot, filename = "/Users/hannahaichelman/Documents/BU/Host_Buffering/MPCC_2018/Sym_analyses/plots/PCA_plasticity_boxplot_symcombined.pdf", width=3, height=3, units=c("in"), useDingbats=FALSE)
...
head(go_input_hot_culture)
write.csv(go_input_hot_culture, file="/Users/hannahaichelman/Documents/BU/Host_Buffering/MPCC_2018/Sym_analyses/GO_Analyses/oculina_hot_symcombined_culture_GO.csv", quote=F, row.names=FALSE)
...
head(go_input_hot_inhost)
write.csv(go_input_hot_inhost, file="/Users/hannahaichelman/Documents/BU/Host_Buffering/MPCC_2018/Sym_analyses/GO_Analyses/oculina_hot_symcombined_inhost_GO.csv", quote=F, row.names=FALSE)
...
head(go_input_cold_culture)
write.csv(go_input_cold_culture, file="/Users/hannahaichelman/Documents/BU/Host_Buffering/MPCC_2018/Sym_analyses/GO_Analyses/oculina_cold_symcombined_culture_GO.csv", quote=F, row.names=FALSE)
...
head(go_input_cold_inhost)
write.csv(go_input_cold_inhost, file="/Users/hannahaichelman/Documents/BU/Host_Buffering/MPCC_2018/Sym_analyses/GO_Analyses/oculina_cold_symcombined_inhost_GO.csv", quote=F, row.names=FALSE)
```

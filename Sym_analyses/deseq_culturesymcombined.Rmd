...
Read in Oculina symbiont counts files, separately for in host and in culture data. The file for the symbionts in host only include brown hosts in creating counts file. 

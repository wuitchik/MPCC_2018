...
countDataSym_brown_noclone = countDataSym_brown %>%
  select(-c(OM1_C_B, OM2_F_B, OM3_H_B))
...
ggsave(plast_boxplot, filename = "/Users/hannahaichelman/Documents/BU/Host_Buffering/MPCC_2018/Sym_analyses/plots/PCA_plasticity_boxplot_syminhost.pdf", width=2.8, height=3, units=c("in"), useDingbats=FALSE)

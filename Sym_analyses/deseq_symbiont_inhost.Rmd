...
dds<-DESeqDataSetFromMatrix(countData=countDataSym_brown_noclone, colData=expDesign_Sym, design=~genotype + treatment) #can only test for the main effects of treatment
dds = DESeq(dds)
results = results(dds)
summary(results)
```
...
# genotype   6      7482  1247.0  1.0378 0.28589  0.226    
# treatment  2      4270  2135.0  1.7768 0.16315  0.001 ***
# Residuals 12     14419  1201.6         0.55096           
